...
/**
 * Initiates user interface for the OrgBalanceInfo application. All listeners for
 ...
 *
 */
public class OrgBalanceInfoUI extends JFrame {
     ...
     */
    public OrgBalanceInfoUI(OrgBalanceInfoData data) {
        this.data = data;
        initUI();
        checkListSize();
     ...
     */
    private void display(OrgBalance user) {
        if (user != null) {
    ...
    private class ButtonListener implements ActionListener {
        ...
        private void savePressed() {
            if (unitname.getText() != null && !unitname.getText().equals("")) {
                OrgBalance o = new OrgBalance(unitname.getText(), credit.getText());
                data.add(o);
            }
            setFieldsEditable(false);
            saveButton.setEnabled(false);
