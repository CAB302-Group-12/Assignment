 ...
 *
 */
public class CreateInfoUI extends JFrame {
     ...
     */
    public CreateInfoUI(CreateInfoData data) {
        this.data = data;
        initUI();
     ...
     * @param create teh Person to display.
     */
    private void display(Create create) {
        if (create != null) {
            name.setText(create.getName());
            category.setText(create.getCategory());
            price.setText(create.getPrice());
            quantity.setText(create.getQuantity());
            organization.setText(create.getOrganization());
            description.setText(create.getDescription());
        }
    }
    ...
    private void savePressed() {
        if (name.getText() != null && !name.getText().equals("")) {
            Create c = new Create(name.getText(), category.getText(), price.getText(), quantity.getText(),  organization.getText(), description.getText());
            data.add(c);
        }
        setFieldsEditable(false);
        saveButton.setEnabled(false);
