 ...
 *
 */
public class AssetInfoUI extends JFrame {
     ...
     */
    public AssetInfoUI(AssetInfoData data) {
        this.data = data;
        initUI();
        checkListSize();
    ...
    private JPanel makeAddressFieldsPanel() {
        ...
        hGroup.addGroup(layout.createParallelGroup().addComponent(name)
                ...
                .addComponent(description).addComponent(organization));
        ...
        private void savePressed() {
            if (name.getText() != null && !name.getText().equals("")) {
                Asset a = new Asset(  name.getText(), category.getText(), price
                        .getText(), quantity.getText(), description.getText(), organization.getText());
                data.add(a);
            }
            setFieldsEditable(false);
            saveButton.setEnabled(false);
