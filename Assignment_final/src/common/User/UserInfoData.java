...
public class UserInfoData {
   ...
   public void add(User u) {
      ...
      if (!listModel.contains(u.getName())) {
         ...
         userData.addUser(u);
      }  else if (!listModel.contains(u.getEmail())) {
         userData.addUser(u);
      }  else if (!listModel.contains(u.getPassword())) {
         userData.addUser(u);
      }  else if (!listModel.contains(u.getUsertype())) {
         userData.addUser(u);
      }  else if (!listModel.contains(u.getOrganization())) {
         userData.addUser(u);
      }
   }
