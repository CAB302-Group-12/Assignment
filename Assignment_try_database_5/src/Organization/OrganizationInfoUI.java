...
/**
 * Initiates user interface for the OrganizationInfo application. All listeners for
 ...
 *
 */
public class OrganizationInfoUI extends JFrame {
     ...
     */
    public OrganizationInfoUI(OrganizationInfoData data) {
        this.data = data;
        initUI();
        checkListSize();
    ...
    private JPanel makeAddressFieldsPanel() {
        ...
        hGroup.addGroup(layout.createParallelGroup().addComponent(unitnameLabel)
                .addComponent(creditLabel).addComponent(assetnameLabel).addComponent(
                        assetquantityLabel));
        hGroup.addGroup(layout.createParallelGroup().addComponent(unitname)
                .addComponent(credit).addComponent(assetname).addComponent(assetquantity));
     ...
     */
    private void display(Organization user) {
        if (user != null) {
    ...
    private class ButtonListener implements ActionListener {
        ...
        private void savePressed() {
            if (unitname.getText() != null && !unitname.getText().equals("")) {
                Organization o = new Organization(unitname.getText(), credit.getText(), assetname
